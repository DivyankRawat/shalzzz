...
export const DraggableCardBody = ({
  ...
  // Pointer position drives a tilt, and a matching sheen sweeps across the
  // card, so the paper reads as a physical thing catching the light.
...
export const DraggableCardContainer = ({
  ...
  <div className={cn("[perspective:3000px] w-full h-full relative", className)}>{children}</div>
);
